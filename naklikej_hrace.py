...
class SwissManagerAutomator:
    ...
    HELP_TEXT = (
        ...
        "\n"
        "Aplikace nedokáže rozpoznat chyby — libovolná nesprávnost ji\n"
        "rozhodí. Například když zadávaný hráč není na Elo listině\n"
        "nahrané ve Swiss-Manageru, dialog se zachová jinak a další\n"
        "stisky kláves půjdou do nesprávných polí. Průběh proto\n"
        "sledujte a při nesrovnalosti dejte STOP.\n"
        "\n"
        "POSTUP\n"
        "\n"
